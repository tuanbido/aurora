<?php
$w = $adminConfig['images'][$image['category_code']]['array_sizes'][0]['w'];
$h = $adminConfig['images'][$image['category_code']]['array_sizes'][0]['h'];
?>
